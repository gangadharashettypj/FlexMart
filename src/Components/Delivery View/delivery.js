...
export default class delivery extends React.Component {
    ...
    getData() {
        axios.get("http://smartshishya.com:5000/delivery/get")
            .then(res => {
                console.log('Data from backend', res.data);
                axios.get("http://smartshishya.com:5000/delivery/get/deliverymen")
                    .then(resp => {
    ...
    handleClickMan(obj) {
        ...
        axios.put("http://smartshishya.com:5000/delivery/update/man", {_id: obj._id, deliveryman: dname})
            .then(res => {
    ...
    handleClickDelivery(obj) {
        axios.put("http://smartshishya.com:5000/delivery/update/delivery", {_id: obj._id})
            .then(res => {
                console.log(res.data);
                this.getData();
            });
    ...
    handleClickRemove(obj) {
        axios.delete("http://smartshishya.com:5000/delivery/remove", {data: {_id: obj._id}})
            .then(res => {
                console.log(res.data);
                this.getData();
            });
