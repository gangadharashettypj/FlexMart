...
class Cart extends React.Component {
    ...
    buy() {
        ...
        Axios.post("http://smartshishya.com:5000/delivery/add", {data: this.state.productList, custid: custid})
            .then((res) => {
                console.log(res.data.message);
                if(edevice) {
                    Axios.post("http://smartshishya.com:5000/customer/productList/edevice/update", edevice)
                        .then(res => {
                            console.log(res.data.message);
                        });
                }
                if(clothes) {
                    Axios.post("http://smartshishya.com:5000/customer/productList/clothes/update", clothes)
                        .then(res => {
                            console.log(res.data.message);
                        });
                }
                if(food) {
                    Axios.post("http://smartshishya.com:5000/customer/productList/food/update", food)
                        .then(res => {
                            console.log(res.data.message);
                        });
                }
                if(furniture) {
                    Axios.post("http://smartshishya.com:5000/customer/productList/furniture/update", furniture)
                        .then(res => {
                            console.log(res.data.message);
                        });
                }
