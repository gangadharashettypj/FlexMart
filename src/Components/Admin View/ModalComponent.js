        ...
        if(this.props.token !== 'customer') {
            ...
            if(etype&&ename&&email&&epwd&&esal) {
                ...
                if(this.props.token === 'admin') {
                    route = "http://smartshishya.com:5000/admin/adminList/update";
                } else if (this.props.token === 'delivery') {
                    route = "http://smartshishya.com:5000/admin/deliveryList/update";
                } else if (this.props.token === 'warehouse') {
                    route = "http://smartshishya.com:5000/admin/warehouseList/update";
                }
                //send to database
                if(eimg) {
            ...
            axios.put("http://smartshishya.com:5000/admin/customerList/update",  empData)
                .then(res => {
                    console.log(res.data.message);
                    this.props.get();
                    document.getElementById('close').click();
