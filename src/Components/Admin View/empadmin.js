...
export default class empadmin extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    search(name) {
        ...
        document.getElementById("adminrecordtabrow" + id).scrollIntoView();
    }
            ...
            elem = (
                <span>
                    <div className="search my-0">
                        <input className="searchTerm" id="adminrecordsearch" type="text" placeholder="Search by name or id..." onChange={this.handleChange} onKeyUp={this.handleKeyUp}/>
                    ...
                    <table id="t01">
                        ...
                        {this.state.data.map(row => {
                                    return(
                                    <tr key={row._id} id={"adminrecordtabrow" + row._id}>
                    ...
                    <ModalComponent row={this.state.rowDetails} get={this.getData} token='admin' />
                </span>
            );
        }
        return(
            <Fragment>
                <Navbar type='adminrecordadmin'/>
                {elem}
            </Fragment>
        );
    }
